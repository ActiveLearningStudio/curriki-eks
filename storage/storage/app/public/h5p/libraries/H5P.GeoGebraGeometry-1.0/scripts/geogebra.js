...
var GGBApplet = function () {
  ...
  var fetchParametersFromApi = function (successCallback, materialsApiUrl) {
    ...
    var url = apiUrl + "/v" + apiVersion + "/materials/" + parameters.material_id + "?scope=basic";
  ...
  var setDefaultHTML5CodebaseForVersion = function (version, offline) {
    ...
    if (index > 0) {
      ...
      codebase = "https://www.geogebra.org/apps/5.0.591.0/"
    }
...
GGBAppletUtils.makeModule = function (name, permutation) {
  function webModule() {
    var I = "bootstrap", J = "begin", K = "gwt.codesvr." + name + "=", L = "gwt.codesvr=", M = name, N = "startup",
      O = "DUMMY", P = 0, Q = 1, R = "iframe",
      S = "position:absolute; width:0; height:0; border:none; left: -1000px;", T = " top: -1000px;",
      U = "CSS1Compat", V = "<!doctype html>", W = "", X = "<html><head></head><body></body></html>",
      Y = "undefined", Z = "readystatechange", $ = 10, _ = "Chrome", ab = 'eval("', bb = '");', cb = "script",
      db = "javascript", eb = "moduleStartup", fb = "moduleRequested", gb = "Failed to load ", hb = "head",
      ib = "meta", jb = "name", kb = name + "::", lb = "::", mb = "gwt:property", nb = "content", ob = "=",
      pb = "gwt:onPropertyErrorFn", qb = 'Bad handler "', rb = '" for "gwt:onPropertyErrorFn"',
      sb = "gwt:onLoadErrorFn", tb = '" for "gwt:onLoadErrorFn"', ub = "#", vb = "?", wb = "/", xb = "img",
      yb = "clear.cache.gif", zb = "baseUrl", Ab = name + ".nocache.js", Bb = "base", Cb = "//",
      Db = "user.agent", Eb = "webkit", Fb = "safari", Gb = "msie", Hb = 11, Ib = "ie10", Jb = 9, Kb = "ie9",
    ...
    B();
    webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.591.0/" + name + "/";
...
if (typeof window.web3d !== "function") {
  web3d = GGBAppletUtils.makeModule("web3d", "48F9B5AB8F207843E496299FC0B4BAF9")
}
if (typeof window.webSimple !== "function") {
  webSimple = GGBAppletUtils.makeModule("webSimple", "59E7BB87970D47A624418487C2581E93")
}

var H5P = H5P || {};

H5P.GeoGebraGeometry = (function ($, UI) {
  /**
  ...
  C.prototype.initializeGeoGabra = function () {
    let base64Val = this.options.geogebra_applet_geometry;
  ...
  C.prototype.registerDOMElements = function () {
    ...
    this.$libraryArea = $('<div />', {
      ...
      html: '<span class="applet-title">' + this.options.title + '</span>'
    });
